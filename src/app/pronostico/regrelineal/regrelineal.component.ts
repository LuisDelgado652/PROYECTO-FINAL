...
import { RegrelinealService } from './regrelineal.service';

@Component({
  selector: 'app-regrelineal',
  templateUrl: './regrelineal.component.html',
  styleUrls: ['./regrelineal.component.css'],
})
export class RegrelinealComponent {
  constructor(private fileUploadService: RegrelinealService) {}
